...
class BoyfriendChatPage extends StatefulWidget {
  const BoyfriendChatPage({super.key});

  @override
  State<BoyfriendChatPage> createState() => _BoyfriendChatPageState();
}

class _BoyfriendChatPageState extends State<BoyfriendChatPage> {
  List<types.Message> _messages = [];
  final _user = types.User(
    id: FirebaseService.getUser()!.uid,
  );
  ...
  void _handleSendPressed(types.PartialText message) {
    ...
    OpenAiService.sendToBoyfriend(message.text);
  }
